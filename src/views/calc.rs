...
const STYLE_CALC: Asset = asset!("/assets/styling/calculator.scss");
...
pub fn Calc() -> Element {
    ...
    rsx! {
        document::Link { rel: "stylesheet", href: STYLE_CALC}
        div { id: "view_calc", class: "calculator", tabindex: "0", onkeydown: handle_key_down_event,
